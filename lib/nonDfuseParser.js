...
var nftstokenByOwnerAddress = function (owner_address,contract_address) {
    return new Promise(async function (resolve, reject) {
        let res = await queries.nftstokenByOwnerAddress(owner_address,contract_address);
        return resolve(res)
    })
}
...
module.exports = {
    ...
    nftstokenByOwnerAddress : nftstokenByOwnerAddress
}